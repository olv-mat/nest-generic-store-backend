...
export class CreatingTables1757702824917 implements MigrationInterface {
    name = 'CreatingTables1757702824917'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order_items" ("id" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL, "quantity" integer NOT NULL, "order_id" uuid, "product_id" uuid, CONSTRAINT "PK_005269d8574e6fac0493715c308" PRIMARY KEY ("id"))`);
